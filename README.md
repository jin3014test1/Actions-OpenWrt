...
8820s为刷高恪硬改spi闪存，高恪玩够了，想刷回openwrt，我觉得改文件比改硬件方便些，所以。。。有了这。固件已经运行几天了，好用，内核版本5.10.113，有r，无kv，可配置vlan。另外预装的ddns、vlmcsd、SmartDNS，没有其他的了。代码库来源于siwind，是否有恶意代码我就没能力鉴别了。也许我该试试openwrt/openwrt指定分支，能更安全。

SmartDNS在这个固件里不好用，一直显示收集数据，不能发挥dns功能，只好关了才能上网。
